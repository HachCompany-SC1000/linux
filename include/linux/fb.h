...
/* from the sh7727fb  (jsp) */
#define FBIOSET_CONTRAST	_IOW('F', 0x20, int)
#define FBIOGET_CONTRAST	_IOR('F', 0x21, int)
#define FBIOSET_LCD		_IOW('F', 0x22, int)
#define FBIOGET_LCD		_IOR('F', 0x23, int)
#define FBIOSETLCD_POWEROFF	(0x01)  /* backlight power off */
#define FBIOSETLCD_POWERON	(0x02)  /* backlight power on */
#define FBIOSETLCD_NIGHT	(0x04)  /* night mode - backlight power should be off but could be on for short */
#define FBIOSETLCD_DAY		(0x08)  /* night mode - backlight power should be off but could be on for short */
#define FBIOSETLCD_DEFAULT	(0x10)  /* update power state: night mode->off, else->on */
