...
/*
 *  Following defines for linux-2.6.21-rc6-git3-sc1000 compatability:
 */
...
// #define ctrl_inb(a)		__raw_readb(a)
// #define ctrl_inw(a)		__raw_readw(a)
// #define ctrl_inl(a)		__raw_readl(a)
// #define ctrl_outb(v,a)		__raw_writeb(v,a)
// #define ctrl_outw(v,a)		__raw_writew(v,a)
// #define ctrl_outl(v,a)		__raw_writel(v,a)

// #define ctrl_inb(a)		readb(a)
// #define ctrl_inw(a)		readw(a)
// #define ctrl_inl(a)		readl(a)
// #define ctrl_outb(v,a)		writeb(v,a)
// #define ctrl_outw(v,a)		writew(v,a)
// #define ctrl_outl(v,a)		writel(v,a)


/* Endof defines for linux-2.6.21-rc6-git3-sc1000 compatability. */
