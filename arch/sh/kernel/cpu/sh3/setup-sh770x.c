...
enum {
	...
	DMAC, SCIF0, 
        SCIF2, 
        SCIF2_ER, SCIF2_RX, SCIF2_BR, SCIF2_TX,
        SCI,/* interrupt group */
        SCI_ER, SCI_RX, SCI_TX, SCI_TE, 
        ADC_ADI,
	LCDC, PCC0, PCC1,
	TMU0, TMU1, TMU2,
	RTC, WDT, REF,
...
static struct intc_vect vectors[] __initdata = {
	...
	INTC_VECT(RTC, 0x4c0),
	INTC_VECT(SCI_ER, 0x4E0), INTC_VECT(SCI_RX, 0x500),
	INTC_VECT(SCI_TX, 0x520), INTC_VECT(SCI_TE, 0x540),
...
//      INTC_VECT(SCI, 0x520), INTC_VECT(SCI, 0x540),
	...
	INTC_VECT(SCIF2_ER, 0x900), INTC_VECT(SCIF2_RX, 0x920),
        INTC_VECT(SCIF2_BR, 0x940), INTC_VECT(SCIF2_TX, 0x960),
...
static struct intc_group groups[] __initdata = {
        INTC_GROUP(SCI, SCI_ER, SCI_RX, SCI_TX, SCI_TE),
        INTC_GROUP(SCIF2, SCIF2_ER, SCIF2_RX, SCIF2_BR, SCIF2_TX),
};

static struct intc_mask_reg mask_registers[] __initdata = {
        { 0xa4000008, 0, 8, /* IRR2 */
          { 0, 0, 0, 0, SCIF2_TX, SCIF2_BR, SCIF2_RX, SCIF2_ER } },
//          { 0xFFFFFE88, 0, 8, /* SCSSR */
//            { SCI_TX, SCI_RX, SCI_ER, SCI_ER, SCI_ER, SCI_TE, 0, 0 } },
};
...
static struct intc_prio_reg prio_registers[] __initdata = {
	...
	{ 0xfffffee4, 0, 16, 4, /* IPRB */ { WDT, REF, SCI, 0 } },
        ...
        { 0xa400001a, 0, 16, 4, /* IPRE */ { 0, 0, SCIF2,ADC_ADI } },
#if defined(CONFIG_CPU_SUBTYPE_SH7706) || \
    defined(CONFIG_CPU_SUBTYPE_SH7707) || \
    defined(CONFIG_CPU_SUBTYPE_SH7709)
...
static DECLARE_INTC_DESC(intc_desc, "sh770x", vectors,groups/* NULL*/,
...
static struct platform_device *sh770x_devices[]  = {
	&scif0_device,
#if defined(CONFIG_CPU_SUBTYPE_SH7706) || \
    defined(CONFIG_CPU_SUBTYPE_SH7707) || \
    defined(CONFIG_CPU_SUBTYPE_SH7709) || \
